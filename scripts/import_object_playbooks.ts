...
const OBJECT_ALIASES: Record<string, string> = {
  ...
  "Волоколамск, 21,7 га у озера": "Волоколамск, 21,7 га у озера",
  "Волоколамск": "Волоколамск, 21,7 га у озера",
  "Volokolamsk": "Волоколамск, 21,7 га у озера",
  "Имущественный комплекс в г. Мытищи": "Имущественный комплекс в г. Мытищи",
  "Продажа земельного участка с имущественным комплексом в г. Мытищи": "Имущественный комплекс в г. Мытищи",
  "Мытищи промка": "Имущественный комплекс в г. Мытищи",
};
...
Если вам интересны такие площадки, могу отправить короткий бриф, схему участка и исходный градостроительный анализ.`,
    ...
    {
      objectName: "Волоколамск, 21,7 га у озера",
      subject: "Волоколамск: 21,7 га у озера под загородный проект",
      letterBody: `Добрый день.

Вижу, что вам могут быть интересны крупные земельные активы в Московской области.

Есть участок 21,7 га: деревня Власьево, Волоколамский муниципальный округ, Московская область. Земля на берегу живописного озера, территория огорожена, отсыпана гравийная дорога до деревни Власьево.

Цена 140 млн рублей. На участке есть своя электроподстанция с трансформатором, скважина, большая баня и двухэтажный дом для персонала.

Назначение: 14,38 га под дачное строительство и 7,3 га земли сельхозназначения. Формат подходит под частное поместье, закрытую семейную резиденцию, клубную усадьбу или камерный загородный проект после проверки градостроительных ограничений.

Если такие активы смотрите, могу отправить короткий бриф и кадастровые номера.`,
      pingOne: "Возвращаюсь по участку 21,7 га в Волоколамском направлении. Это закрытый массив у озера с подстанцией, скважиной, баней и домом для персонала. Могу отправить короткий бриф и кадастровые номера.",
      monthlyPlan: plan(55, 25, 42),
      weeklyPlan: plan(14, 6, 11),
      dailyPlan: plan(3, 1, 2),
    },
    {
      objectName: "Имущественный комплекс в г. Мытищи",
      subject: "Мытищи: промышленная площадка 11,8 га с ж/д веткой",
      letterBody: `Добрый день.

Есть промышленная площадка в г. Мытищи: земельный участок 11,8 га с имущественным комплексом 58 000 м².

ВРИ - промышленное использование. На территории есть железнодорожная ветка.

Коммуникации: разрешенная электрическая мощность 4,6 МВт, теплоэнергия 6 392,4 Гкал, газ 3 408,59 тыс. м³, водопотребление 27,972 тыс. м³, водоотведение 25,454 тыс. м³.

Установлена санитарно-защитная зона: 100 м от основной группы источников выбросов и 50 м от границы территории.

Стоимость раскрывается по запросу. Если вы рассматриваете площадки под производство, склад, логистику или промышленный арендный кластер, могу отправить короткий бриф и состав исходных данных.`,
      pingOne: "Возвращаюсь по промышленной площадке в Мытищах: 11,8 га, 58 000 м² зданий, ж/д ветка, 4,6 МВт. Если такие объекты смотрите, могу отправить короткий бриф.",
      monthlyPlan: plan(55, 25, 42),
      weeklyPlan: plan(14, 6, 11),
      dailyPlan: plan(3, 1, 2),
    },
